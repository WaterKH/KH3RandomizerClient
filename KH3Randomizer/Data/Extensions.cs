    ...
    public static class Extensions
    {
        ...
        public static string KeyIdToDisplay(this string input)
        {
            ...
            return input.Replace("\u0000", "") switch
            {
                ...
                "EVENT_002" => "Find Golden Herc Figure in Thebes: Alleyway",
                "EVENT_003" => "Find Golden Herc Figure in Thebes: Garden",
                "EVENT_004" => "Find Golden Herc Figure in Thebes: Garden",
                "EVENT_005" => "Find Golden Herc Figure in Thebes: Overlook",
                "EVENT_006" => "Find Golden Herc Figure in Thebes: Agora",
                "EVENT_007" => "Return All Golden Herc Figures",
                "EVENT_008" => "Defeat the Unversed in The Factory: Second Floor",
                "EVENT_009" => "Rescue the Trapped Big Hero 6 Members",
                "TresUIMobilePortalDataAsset" => "Complete All Classic Kingdom Minigames",
                "EVENT_KEYBLADE_001" => "Defeat Tornado Titan & Complete Olympus",
                "EVENT_KEYBLADE_002" => "Complete Twilight Town",
                "EVENT_KEYBLADE_003" => "Defeat King of Toys & Complete Toy Box",
                "EVENT_KEYBLADE_004" => "Defeat Grim Guardianess & Complete Kingdom of Corona",
                "EVENT_KEYBLADE_005" => "Defeat Lump of Horror & Complete Monstropolis",
                "EVENT_KEYBLADE_006" => "Complete 100 Acre Wood",
                "EVENT_KEYBLADE_007" => "Defeat Skoll & Complete Arendelle",
                "EVENT_KEYBLADE_008" => "Defeat Davy Jones & Complete The Caribbean",
                "EVENT_KEYBLADE_009" => "Defeat Dark Baymax & Complete San Fransokyo",
                "EVENT_KEYBLADE_010" => "Complete All of Little Chef's Recipes",
                ...
                "EVENT_REPORT_001a" or "EVENT_REPORT_001b" => "Complete Battlegate 1 in Olympus",
                "EVENT_REPORT_002a" or "EVENT_REPORT_002b" => "Complete Battlegate 2 in Olympus",
                "EVENT_REPORT_003a" or "EVENT_REPORT_003b" => "Complete Battlegate 3 in Twilight Town",
                ...
                "EVENT_REPORT_006a" or "EVENT_REPORT_006b" => "Complete Battlegate 6 in Kingdom of Corona",
                "EVENT_REPORT_007a" or "EVENT_REPORT_007b" => "Complete Battlegate 7 in Kingdom of Corona",
                "EVENT_REPORT_008a" or "EVENT_REPORT_008b" => "Complete Battlegate 8 in Monstropolis",
                "EVENT_REPORT_009a" or "EVENT_REPORT_009b" => "Complete Battlegate 9 in Arendelle",
                "EVENT_REPORT_010a" or "EVENT_REPORT_010b" => "Complete Battlegate 10 in The Caribbean",
                "EVENT_REPORT_011a" or "EVENT_REPORT_011b" => "Complete Battlegate 11 in San Fransokyo",
                "EVENT_REPORT_012a" or "EVENT_REPORT_012b" => "Complete Battlegate 12 in San Fransokyo",
                "EVENT_REPORT_013a" or "EVENT_REPORT_013b" => "Complete Battlegate 13 in The Keyblade Graveyard: ",
        ...
        public static string KeyIdToDescription(this string input)
        {
            return input.Replace("\u0000", "") switch
            {
                ...
                "Vbonus_010" => "Defeat Rock Titan in Olympus",
                "Vbonus_011" => "After the Satyr Mob battle in Olympus - Realm of the Gods: Courtyard",
                "Vbonus_013" => "Defeat Tornado Titan in Olympus",
                "Vbonus_014" => "Defeat Demon Tide in Twilight Town - Tram Common",
                ...
                "Vbonus_019" => "After the Supreme Smashers battle in Toy Box - Action Figures",
                ...
                "Vbonus_023" => "Defeat King of Toys in Toy Box",
                ...
                "Vbonus_030" => "Defeat Grim Guardianess in Kingdom of Corona - Tower",
                ...
                "Vbonus_041" => "Defeat Rock Troll in Arendelle",
                ...
                "Vbonus_047" => "Defeat Marshmallow in Arendelle",
                ...
                "Vbonus_051" => "Defeat Metal Troll on the bridge in San Fransokyo",
                ...
                "Vbonus_060" => "Defeat Raging Vulture in The Caribbean",
                "Vbonus_061" => "Defeat Lightning Angler in The Caribbean",
                ...
                "Vbonus_065" => "Defeat the Kraken in The Caribbean",
                "Vbonus_066" => "Defeat Davy Jones in The Caribbean",
                "Vbonus_067" => "Defeat Anti-Aqua boss battle in The Dark World",
                "Vbonus_068" => "Defeat the last Lich in San Fransokyo",
                "Vbonus_069" => "After the Heartless, Nobody & Unversed Mob battle in The Keyblade Graveyard",
                "Vbonus_070" => "Defeat Demon Tide in The Keyblade Graveyard",
                "Vbonus_071" => "Defeat Xigbar & Dark Riku in The Keyblade Graveyard",
                "Vbonus_072" => "Defeat Luxord, Marluxia, & Larxene in The Keyblade Graveyard",
                "Vbonus_073" => "Defeat Vanitas & Terra-Xehanort in The Keyblade Graveyard",
                "Vbonus_074" => "Defeat Saix in The Keyblade Graveyard",
                "Vbonus_075" => "Defeat Young Xehanort, Ansem, & Xemnas in The Keyblade Graveyard",
                ...
                "VBonus_DLC_004" => "Defeat Xigbar & Dark Riku in The Keyblade Graveyard (Re+Mind)",
                "VBonus_DLC_005" => "Defeat Luxord, Marluxia, & Larxene in The Keyblade Graveyard (Re+Mind)",
                "VBonus_DLC_006" => "Defeat Vanitas & Terra-Xehanort in The Keyblade Graveyard (Re+Mind)",
                "VBonus_DLC_007" => "After the Saix boss battle in The Keyblade Graveyard (Re+Mind)",
                "VBonus_DLC_008" => "Defeat Young Xehanort, Ansem, & Xemnas in The Keyblade Graveyard (Re+Mind)",
                "VBonus_DLC_009" => "After the Shadow Heartless battle in Scala ad Caelum (Re+Mind)",
                "VBonus_DLC_010" => "Defeat Darkside in Scala ad Caelum (Re+Mind)",
        ...
        public static string GetChestLocation(this string chest, DataTableEnum dataTableEnum)
        {
            return dataTableEnum switch
            {
                ...
                DataTableEnum.TreasureTS => chest switch
                {
                    ...
                    "Small Chest 3" => "Chest 6 (Small Chest, Galaxy Toys: Above Entrance)",
                ...
                DataTableEnum.TreasureRA => chest switch
                {
                    ...
                    "Small Chest 18" => "Chest 23 (Small Chest, The Kingdom: Festival Dance Area)",
                ...
                {
                    "Large Chest 1" => "Chest 1 (Large Chest, Monsters, Inc.: Lobby & Offices)",
                    ...
                    "Small Chest 1" => "Chest 2 (Small Chest, Monsters, Inc.: Lobby & Offices)",
                    "Small Chest 2" => "Chest 3 (Small Chest, Monsters, Inc.: Laugh Floor)",
                ...
                {
                    "Large Chest 1" => "Chest 51 (Large Chest, Port Royal: Docks)",
                    "Large Chest 2" => "Chest 17 (Large Chest, Isla de los Mástiles)",
                    "Large Chest 3" => "Chest 18 (Large Chest, Ship's End)",
                    "Large Chest 4" => "Chest 19 (Large Chest, Sandbar Isle)",
                    "Large Chest 5" => "Chest 20 (Large Chest, The Huddled Isles)",
